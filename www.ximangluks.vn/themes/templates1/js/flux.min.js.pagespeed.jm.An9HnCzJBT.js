...
(function(b) {
    flux.browser = {
            ...
            if (flux.browser.supportsTransitions === undefined) {
                ...
                if (window.Modernizr && Modernizr.csstransforms3d !== undefined) flux.browser.supports3d = Modernizr.csstransforms3d;
                    ...
                    if (flux.browser.supports3d && "webkitPerspective" in b("body").get(0).style) {
                        ...
                        c = b('<style media="(transform-3d), (' + c.join("-transform-3d),(") + '-transform-3d)">div#csstransform3d { position: absolute; left: 9px }</style>');
                        b("body").append(e);
                        b("head").append(c);
        ...
        supportsCSSProperty: function(c) {
            for (var e = document.createElement("div"), a = ["Webkit", "Moz", "O", "Ms"], d = false, f = 0; f < a.length; f++)
...
(function(b) {
    ...
    b.fn.transitionEnd = function(c) {
        for (var e = ["webkitTransitionEnd", "transitionend", "oTransitionEnd"], a = 0; a < e.length; a++) this.bind(e[a], function(d) {
    ...
    flux.transition_grid = function(c, e) {
        return new flux.transition(c, b.extend({
            ...
            setup: function() {
                ...
                for (var j = 0, k = 0, q = document.createDocumentFragment(), m = 0; m < this.options.columns; m++) {
                    var n = f;
                    k = 0;
                    if (a > 0) {
                        var l = a >= h ? h : a;
            ...
            renderTile: function(a, d, f, g, h, i) {
                ...
                var j = b(f.get(0).cloneNode(false)).css({
                    ...
                    k = b('<div class="side bar-' + d + '"></div>').css({
                        ...
                        transform: flux.browser.rotateY(90) + " " + flux.browser.translate(h / 2, 0, -h / 2) + " " + flux.browser.rotateY(180),
                        "backface-visibility": "hidden"
                    });
        ...
        return new flux.transition_grid(c, b.extend({
            ...
            renderTile: function(a, d, f, g, h, i, j) {
                b(a).css({
                    ...
                    "transition-timing-function": "ease-in",
                    "transition-property": "all",
                    "transition-delay": (d + f) * this.options.delayBetweenDiagnols + "ms",
                    "backface-visibility": "hidden"
                })
            },
            execute: function() {
    ...
    flux.transitions.cube = function(c, e) {
        return new flux.transition(c, b.extend({
            ...
            transitionStrings: function(a, d) {
                ...
                f = {
                    up: {
                        nextFace: flux.browser.rotateX(-90) + " " + flux.browser.translate(0, g / 2, g / 2),
                        container: flux.browser.rotateX(90) + " " + flux.browser.translate(0, -g / 2, g / 2)
                    },
                    down: {
                        nextFace: flux.browser.rotateX(90) + " " + flux.browser.translate(0, -g / 2, g / 2),
                        container: flux.browser.rotateX(-90) + " " + flux.browser.translate(0, g / 2, g / 2)
                    ...
                    left: {
                        nextFace: flux.browser.rotateY(90) + " " + flux.browser.translate(f / 2, 0, f / 2),
                        container: flux.browser.rotateY(-90) + " " + flux.browser.translate(-f / 2, 0, f / 2)
                    },
                    right: {
                        nextFace: flux.browser.rotateY(-90) + " " + flux.browser.translate(-f / 2, 0, f / 2),
                        container: flux.browser.rotateY(90) + " " + flux.browser.translate(f / 2, 0, f / 2)
        ...
        return new flux.transition_grid(c, b.extend({
            ...
            renderTile: function(a, d, f, g, h, i, j) {
                ...
                b(a).css({
                    ...
                    "transition-property": "all",
                    "transition-delay": d * this.options.delayBetweenBarsX + f * this.options.delayBetweenBarsY + "ms",
                    "transform-style": "preserve-3d"
                }).append(g).append(h)
            },
            execute: function() {
